 ...
 */
public class SamuelHavardWeek8 extends javax.swing.JFrame {

    /**
     * Creates new form SamuelHavardWeek6
     */
    public SamuelHavardWeek8() {
        initComponents();
    }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        try {
            ...
            Logger.getLogger(SamuelHavardWeek8.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private void btnSubmit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmit1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(SamuelHavardWeek8.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SamuelHavardWeek8().setVisible(true);
        });
    }
